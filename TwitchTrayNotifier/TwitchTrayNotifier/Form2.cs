...
namespace TwitchTrayNotifier
{
    public partial class SettingsForm : Form
    {
        ...
        public SettingsForm()
        {
            ...
            System.IO.StreamReader myFile = new System.IO.StreamReader("d:\\username.txt"); //Set to actual location for the text document
            Username = myFile.ReadToEnd();
            myFile.Close();

            //Uses Twitch API to see who the user follows
            string cUrl = "https://api.twitch.tv/kraken/users/" + Username + "/follows/channels";
            HttpWebRequest wRequest = (HttpWebRequest)HttpWebRequest.Create(cUrl);
            ...
            //Using a for loop, assigns all the channels they follow to the array Follows
            for (int i = 1; i <= 9; i++)
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (Username != "")
            {
                ...
                System.IO.StreamWriter myFile = new System.IO.StreamWriter("d:\\username.txt"); //Need to set actual location for file
